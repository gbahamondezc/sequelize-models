...
describe("PSQL -> Queries tests", function() {
  ...
  it("PSQL -> Find user by id 1", function(done) {
  ...
  it("PSQL -> Find all profiles with name Technicians including his users", function(done) {
  ...
  it("PSQL -> Find all users with name Gonzalo including his profiles", function(done) {
